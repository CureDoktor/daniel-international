...
export default function VideoCourse({ setContent }) {
  return (
    <div className="md:flex justify-between pt-10">
      ...
      <div className="pt-10 md:pt-0 md:ml-10 md:h-[500px]">
        ...
        <iframe
          ...
          frameborder="0"
          className="h-auto w-[100%] md:h-[100%] md:w-[100%]"
        ...
        <div className="bg-white p-6">
          ...
          <p className="text-[#8893AC] text-[14px] py-2">
            ...
            for more advanced IQ challenges, helping you to enhance your mental
